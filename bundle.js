~ function() {
    ...
    (function(r) {
        ...
        return p(p.s = 0)
            ...
            var somethinglolcuzimlazy = "blixxbeta"
                            ...
                            if (q.guns.length === n.guns.length)
                                for (w = q.guns.getPositions(),
                                    ...
                                    var D = n.guns[A],
                                        ...
                                        D.color != undefined ? k(h, T(e(D.color), F.status.getColor(), F.status.getBlend())) : k(h, T(e(16), F.status.getColor(), F.status.getBlend()));
            ...
            const p = {
                ...
                arras: (a, e = 5E3) => `${a}.arras.io:${e}`,
                arrasUnknown: (a, e = 5E3) => `${a}.arras.io:${e}`
            };
